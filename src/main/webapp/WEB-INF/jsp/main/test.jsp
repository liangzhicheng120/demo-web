...
<link href="<%=basePath%>Charisma/jquery-gallery/example1/colorbox.css" rel="stylesheet">
<!--[if lt IE 9]>
...
<body>
	...
	<script src="<%=basePath%>Charisma/jquery-gallery/jquery.colorbox-min.js"></script>
	...
	<script>
		...
		$('#sumbitBtn').on('click', function() {
			common.doAjaxWithNotAsync('note/initmodel', {
