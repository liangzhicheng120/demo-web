$(document).ready(
		function() {
			...
			$(document).mouseup(
					function(e) {
						if (!$sidebarNav.is(e.target) && $sidebarNav.has(e.target).length === 0 && !$(".navbar-toggle").is(e.target)
								&& $(".navbar-toggle").has(e.target).length === 0 && $sidebarNav.hasClass("active")) {
							e.stopPropagation();
							$(".navbar-toggle").click()
						}
					});
	...
	"bootstrap" : {
		"fnInit" : function(oSettings, nPaging, fnDraw) {
			...
			$(nPaging).addClass("pagination").append(
					'<ul class="pagination">' + '<li class="prev disabled"><a href="#">&larr; ' + oLang.sPrevious + "</a></li>"
